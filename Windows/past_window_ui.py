...
"}")
        ...
        self.begin_date_label.setFont(font1)
...
"font-size: 20px;")
        ...
        self.department_label.setFont(font2)
...
"font-size: 20px;")
        ...
        self.name_filter.setMinimumSize(QSize(220, 40))
        self.name_filter.setMaximumSize(QSize(220, 40))
...
"padding-left: 8px;")
        ...
        self.department_filter.setMinimumSize(QSize(220, 40))
        self.department_filter.setMaximumSize(QSize(220, 40))
...
"padding-left: 8px;")
        ...
        self.past_weeks_label.setFont(font1)
        self.past_weeks_label.setStyleSheet(u"font-size: 39px;\n"
"color: black;\n"
"border: 2px solid #555; \n"
"")
        self.past_weeks_label.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
